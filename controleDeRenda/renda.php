		...
		<header>
			...
			<aside>
				...
				<div class="left_menu">
					...
					<div class="menuText">
						<input type="button" value="Registrar Gastos" onClick="MostrarButton('registrar_gastos', 'calcular_ganhos', 'calcular_lucro', 'calcular_gastos')" class="btn btn-secondary btn-sm"/>
					</div>
				</div>
			</aside>
